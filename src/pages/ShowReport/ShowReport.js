        ...
        <div className="container">
          ...
          <div className="col-lg-8 mt-4 me-5 m-3">
            ...
            <div className="containre mb-4">
              <p>
                <b>Note :</b>
                "Cervical cytology is a screening test and has associated false
                negative and false positive results. Regular sampling and follow
                up is recommended".
                <br />
                <br />
              ...
              1. The smears are reported using the Bethesda System for Reporting
              ...
              <table className="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <th scope="row">1</th>
                    <td>
                      Younger than 21 years: recommends against screening Grade
                      D recommendation
                    </td>
                    <td>Younger than 25 years: recommends against screening</td>
                  </tr>
                  <tr>
                    <th scope="row">2</th>
                    <td>
                      ...
                      alone, every 5 years with high-risk human papillomavirus
                      (hrHPV) testing alone, or every 5 years with hrHPV testing
                      in combination with cytology (cotesting). Grade A
                      recommendation
                    </td>
                    <td>
                      ...
                      combination with cytology) every 5 years or cytology alone
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      cervical cancer in women older than 65 years who have had
                      adequate prior screening and are not otherwise at high
                      risk for cervical cancer. Grade D recommendation
                    </td>
                    <td>
                      Older than 65 years: Women who have no history of cervical
                      intraepithelial neoplasia grade 2 or a more severe
                      diagnosis within the past 25 years, and who have
                      documented adequate negative prior screening in the 10-y
                      period before age 65 years discontinue cervical cancer
                      screening with any modality, Individuals older than age 65
                      y without conditions limiting life expectancy for whom
                      sufficient documentation of prior screening is not
                      available should be screened until criteria for screening
                      cessation are met
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      ...
                      cervical cancer in women who have had a hysterectomy with
                      removal of the cervix and do not have a history of a
                      high-grade precancerous lesion (ie, cervical
                  ...
                  <tr>
                    <th scope="row">5</th>
                    <td>
                      HPV vaccinated: Recommended screening practices should not
