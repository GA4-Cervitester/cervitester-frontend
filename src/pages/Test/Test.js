        ...
        <div>
           ...
           <div className="testTopInfo" style={{fontSize: "small"}}>
               <div style={{borderRadius: "10px"}}>
                ...
                An image based AI tool to assess the risk and probability of having Cervical Cancer. 
                Capture or upload images to proceed with the prediction.
                </div>
           </div>
           <div className="centerText" style={{margin: "25px 0", fontSize: "1.2rem"}}>
               Select Test Type
           </div>
            <div className="testBoxesContainer">
                <Grid container spacing={2} className="centerDiv">
                    <Grid item xs={6} sm={6}>
                        <NavLink to={{pathname: '/testSteps', testType: "Pap Smear"}} exact>
                    ...
                    <Grid item xs={6} sm={6}>
                        <NavLink to={{pathname: '/testSteps', testType: "Colposcopy"}} exact> 
                        <div className="bigGridBox centerDiv1">
                            <div className="testBoxText">
                                Colposcopy Test
                            </div>
